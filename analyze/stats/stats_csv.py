...
puppet_dir = '/media/data/lucen/codebase/yt-sock-puppet/output_v6_success/puppets'
experiment_dir = '/media/data/lucen/codebase/yt-sock-puppet/experiment_data_v6_success'
output_csv = 'puppet_experiment_summary_v6.csv'
...
for puppet_path in puppet_files:
    ...
    data = {
        'puppet_id': puppet_id,
        'harmful_percent': puppet_id.split('_')[1].split(',')[0],
        'trainingN': trainingN,
        'steps': steps,
        'rounds': rounds,
        'focus': focus,
